...
public class FriendsAdapter extends BaseAdapter {
    ...
    /* renamed from: com.gitrose.mobile.adapter.FriendsAdapter.1 */
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.friends_user_head:
                    FriendsAdapter.this.startPersonalActivity(((UserInfo) FriendsAdapter.this.mUsersList.get(Integer.parseInt(view.getTag().toString()))).getUid());
//                case R.id.friends_follow_cancle:
//                    FriendsAdapter.this.mSwipeMenuListView.smoothCloseMenu(Integer.parseInt(view.getTag().toString()) + 1);
                default:
            }
        }
    }
    ...
    public FriendsAdapter(Context context) {
        this.mOnClickListener = new C03381();
        this.mContext = context;
    }

    public FriendsAdapter(Context context, List<UserInfo> users) {
        this.mOnClickListener = new C03381();
        this.mContext = context;
        this.mUsersList = users;
    }

    public FriendsAdapter(Context mContext, List<UserInfo> mUsers, SwipeMenuListView menuListView) {
        this.mOnClickListener = new C03381();
