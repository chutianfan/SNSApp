...
public class TopicEmotionAdapter extends ArrayListAdapter<CommentEmotion> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(this.mContext, R.layout.topic_emotion_title_item, null);
        ...
        ImageLoader.getInstance().displayImage(new StringBuilder(ConstantURL.TOPIC_DOWNLOAD_EMOTION).append(((CommentEmotion) this.mList.get(position)).getTypepic()).append(".png").toString(), viewHolder.iv_comment_title);
