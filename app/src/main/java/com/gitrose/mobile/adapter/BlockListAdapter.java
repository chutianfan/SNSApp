...
public class BlockListAdapter extends BaseAdapter {
    ...
    /* renamed from: com.gitrose.mobile.adapter.BlockListAdapter.1 */
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.friends_user_head:
                    BlockListAdapter.this.startPersonalActivity(((UserInfo) BlockListAdapter.this.mUsersList.get(Integer.parseInt(view.getTag().toString()))).getUid());
                default:
            }
        }
    }
    ...
    public BlockListAdapter(Context context, List<UserInfo> users) {
        this.mOnClickListener = new C03361();
