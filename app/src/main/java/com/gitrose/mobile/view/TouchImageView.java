...
public class TouchImageView extends ImageView {
    ...
    /* renamed from: com.gitrose.mobile.view.TouchImageView.1 */
    class C03721 implements OnTouchListener {
        C03721() {
        }
...
//                    break;
    ...
    public TouchImageView(Context context) {
        ...
        this.minScale = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
        this.maxScale = 3.0f;
        this.saveScale = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    ...
    private void sharedConstructing(Context context) {
        ...
        this.f1182m = new float[9];
        setImageMatrix(this.matrix);
        setScaleType(ScaleType.MATRIX);
        setOnTouchListener(new C03721());
    }
    ...
    void fixTrans() {
        this.matrix.getValues(this.f1182m);
        float transX = this.f1182m[ZOOM];
        float transY = this.f1182m[5];
