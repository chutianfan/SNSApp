...
public class Base64Coder {
    ...
    static {
        ...
        i2 = i + 1;
        map1[i] = '/';
        map2 = new byte[TransportMediator.FLAG_KEY_MEDIA_NEXT];
    ...
    public static char[] encode(byte[] in, int iOff, int iLen) {
        ...
        while (ip < iEnd) {
            ...
            int i2;
            int ip2 = ip + 1;
            int i0 = in[ip] & TIM_IMAGE_FORMAT_UNKNOWN;
            if (ip2 < iEnd) {
                ip = ip2 + 1;
                i1 = in[ip2] & TIM_IMAGE_FORMAT_UNKNOWN;
            } else {
                i1 = 0;
                ip = ip2;
            }
            if (ip < iEnd) {
                ip2 = ip + 1;
                i2 = in[ip] & TIM_IMAGE_FORMAT_UNKNOWN;
            } else {
                i2 = 0;
                ip2 = ip;
            }
