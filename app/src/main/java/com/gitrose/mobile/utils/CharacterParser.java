...
//    }
    ...
    private int getChsAscii(String chs) {
        ...
        try {
            ...
            //return (((bytes[0] + FileUtils.f1479b) * FileUtils.f1479b) + (bytes[1] + FileUtils.f1479b)) - AccessibilityNodeInfoCompat.ACTION_CUT;
        } catch (Exception e) {
